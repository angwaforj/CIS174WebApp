...
using CIS174WebApp.Models.AccountViewModel;
...
namespace CIS174WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {               
                    ...
                    //var adminClaim = new Claim("IsAdmin", "Admin");
                    //var contClaim = new Claim("ContentEditor", "Editor");
                    await _userManager.AddClaimAsync(user, nameClaim);
                    //await _userManager.AddClaimAsync(user, adminClaim);
                    //await _userManager.AddClaimAsync(user, contClaim);
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(AuthorController.Index), "Author");
        }
